...
export function ChatBox({
  ...
  return (
    <div className="flex h-full flex-col rounded-2xl border border-border/70 bg-card/75">
      ...
      <div className="border-t border-border/70 p-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <Input
            ...
            placeholder={disabled ? 'Messaging disabled for your role' : 'Type a message... Use @username to mention'}
