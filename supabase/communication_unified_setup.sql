-- TaskFlow Communication Unified Setup
-- Single Supabase SQL script for conversations, messages, calls, RLS, and realtime.
...
create table if not exists public.calls (
  ...
  group_call boolean default false,
...
-- Conversation members: creator can insert; members can read the roster.
...
-- Messages: only conversation participants can read and write.
...
-- Calls: participants can read/update; creators can insert.
